...
- `@img/sharp-win32-x64@0.35.4` — https://sharp.pixelplumbing.com

### MPL-2.0

- `@resvg/resvg-wasm@2.4.1` — https://github.com/yisibl/resvg-js#readme
- `@vercel/og@1.0.2` — https://github.com/vercel/og#readme
...
- `satori@0.33.3` — https://github.com/vercel/satori#readme
...
- `@asamuzakjp/css-color@6.0.5` — https://github.com/asamuzaK/cssColor#readme
- `@asamuzakjp/dom-selector@8.3.2` — https://github.com/asamuzaK/domSelector#readme
...
- `@esbuild/win32-x64@0.28.2` — https://github.com/evanw/esbuild#readme
...
- `@types/d3-delaunay@6.0.1` — https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/d3-delaunay
- `@types/d3-format@3.0.1` — https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/d3-format
- `@types/d3-geo@3.1.0` — https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/d3-geo
- `@types/d3-interpolate@3.0.1` — https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/d3-interpolate
- `@types/d3-path@3.1.1` — https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/d3-path
- `@types/d3-scale@4.0.2` — https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/d3-scale
- `@types/d3-shape@3.1.7` — https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/d3-shape
- `@types/d3-time@3.0.0, 3.0.4` — https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/d3-time
- `@types/d3-time-format@2.1.0` — https://github.com/DefinitelyTyped/DefinitelyTyped#readme
...
- `@visx/group@4.0.1-alpha.0` — https://github.com/airbnb/visx#readme
- `@visx/point@4.0.1-alpha.0` — https://github.com/airbnb/visx#readme
- `@visx/responsive@4.0.1-alpha.0` — https://github.com/airbnb/visx#readme
- `@visx/scale@4.0.1-alpha.0` — https://github.com/airbnb/visx#readme
- `@visx/shape@4.0.1-alpha.0` — https://github.com/airbnb/visx#readme
- `@vitest/coverage-v8@4.1.11` — https://vitest.dev/guide/coverage
- `@vitest/expect@4.1.11` — https://vitest.dev/api/expect
- `@vitest/mocker@4.1.11` — https://github.com/vitest-dev/vitest/tree/main/packages/mocker
- `@vitest/pretty-format@4.1.11` — https://github.com/vitest-dev/vitest/tree/main/packages/pretty-format
- `@vitest/runner@4.1.11` — https://vitest.dev/api/advanced/runner
...
- `es-module-lexer@2.3.2` — https://github.com/guybedford/es-module-lexer#readme
- `esbuild@0.28.2` — https://github.com/evanw/esbuild#readme
...
- `fast-xml-builder@1.3.1` — https://github.com/NaturalIntelligence/fast-xml-builder#readme
- `fast-xml-parser@5.11.1` — https://github.com/NaturalIntelligence/fast-xml-parser#readme
- `fdir@6.5.0` — https://github.com/thecodrr/fdir#readme
- `fflate@0.7.3, 0.7.5` — https://101arrowz.github.io/fflate
...
- `harfbuzzjs@0.10.0` — https://github.com/harfbuzz/harfbuzzjs#readme
...
- `std-env@3.10.0, 4.2.0` — https://github.com/unjs/std-env#readme
...
- `tinyrainbow@3.1.1` — https://github.com/tinylibs/tinyrainbow#readme
- `tldts@7.4.10` — https://github.com/remusao/tldts#readme
...
- `@prisma/debug@7.2.0, 7.10.0` — https://www.prisma.io
- `@prisma/driver-adapter-utils@7.10.0` — https://github.com/prisma/prisma#readme
- `@prisma/engines@7.10.0` — https://github.com/prisma/prisma#readme
- `@prisma/engines-version@7.10.0-4.0edf323efd1d98336f3f0a68684b56f689b900d3` — https://github.com/prisma/engines-wrapper#readme
- `@prisma/fetch-engine@7.10.0` — https://www.prisma.io
- `@prisma/get-platform@7.2.0, 7.10.0` — https://www.prisma.io
...
- `d3-array@3.2.1, 3.2.4` — https://d3js.org/d3-array/
- `d3-color@3.1.0` — https://d3js.org/d3-color/
- `d3-delaunay@6.0.2` — https://github.com/d3/d3-delaunay
- `d3-format@3.1.0, 3.1.2` — https://d3js.org/d3-format/
- `d3-geo@3.1.0` — https://d3js.org/d3-geo/
...
- `robust-predicates@3.0.3` — https://github.com/mourner/robust-predicates#readme
