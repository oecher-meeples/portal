...
import type { HelperShift, ShiftStatus } from "@/data/helferplan";
...
type HelferMockViewProps = {
  eventTitle: string;
  shifts: HelperShift[];
};

export function HelferMockView({ eventTitle, shifts }: HelferMockViewProps) {
  return (
    <div className="flex flex-col gap-6">
      <PageHeading
        eyebrow="Event-Betrieb"
        title={`Helferplan Â· ${eventTitle}`}
